...
#define KERNEL_ASPACE_BITS (NBITS(KERNEL_ASPACE_TOP-KERNEL_ASPACE_BASE))
#define KERNEL_BASE_BITS (NBITS(KERNEL_ASPACE_TOP-KERNEL_BASE))
...
#define MMU_KERNEL_SIZE_MASK ((1 << MMU_KERNEL_SIZE_SHIFT) - 1) 
...
/* add by pwang support 4k page for tg0  */
#define MMU_TG0(page_size_shift) (((page_size_shift == 12) & 0) |\
				  (((page_size_shift == 14) & 1) << 1) | \
...
#define MMU_TCR_IPS(size)                       BM(16, 3, (size))
...
/* add by peter wang  */
#define MMU_TCR_FLAGS0_1 (MMU_TCR_TG0(MMU_TG0(MMU_KERNEL_PAGE_SIZE_SHIFT)) | \
                          MMU_TCR_SH0(MMU_SH_INNER_SHAREABLE) | \
                          MMU_TCR_ORGN0(MMU_RGN_WRITE_BACK_ALLOCATE) | \
                          MMU_TCR_IRGN0(MMU_RGN_WRITE_BACK_ALLOCATE) | \
                          MMU_TCR_T0SZ(64 - MMU_KERNEL_SIZE_SHIFT))

/* peter wang: there is no 1 in tcr_el2  */
#if 0
#define MMU_TCR_FLAGS_IDENT (MMU_TCR_IPS_DEFAULT | MMU_TCR_FLAGS1 | MMU_TCR_FLAGS0_1)
#define MMU_TCR_FLAGS_KERNEL (MMU_TCR_IPS_DEFAULT | MMU_TCR_FLAGS1 | MMU_TCR_FLAGS0 | MMU_TCR_EPD0)
#else
#define MMU_TCR_FLAGS_IDENT (MMU_TCR_IPS_DEFAULT | MMU_TCR_FLAGS0)
#define MMU_TCR_FLAGS_KERNEL (MMU_TCR_IPS_DEFAULT | MMU_TCR_FLAGS0 | MMU_TCR_EPD0)
#endif 
...
/*  delete MMU_PTE_ATTR_UXN for code segment in el2, for this bit means never execute in el2  */
