...
void arm64_sync_exception(struct arm64_iframe_long *iframe) {
    ...
    switch (ec) {
        ...
        case 0b100101: { /* data abort from same level */
            ...
            uint64_t far = ARM64_READ_SYSREG(far_el2);
        ...
        default:
	    if (hyper_sync_exception(iframe, esr)) /* hypervisor related traps  */
		    return;
    }
