...
#define DEFAULT_MEMORY_SIZE (0x20000000) /* try to fetch from the emulator via the fdt */
#define VA_EQUAL_PA_START MEMORY_BASE_PHYS + KERNEL_LOAD_OFFSET

/* initial memory mappings. parsed by start.S */
struct mmu_initial_mapping mmu_initial_mappings[] = {
    /* all of memory  part 1 va == pa va == pa for start */
    {
